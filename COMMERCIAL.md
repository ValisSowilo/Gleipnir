...
This page exists for the one case the GPL does not cover.
...
There is no price list. Say roughly what you are building and what terms you
need, and we can work it out.

## What has not changed

You may read the source, build it, modify it, redistribute it, and use it in
production, for free, forever, without asking me. That was already true under
the previous licence for most users; under the GPL it is true for everyone.
